...
const selectBicoByCandidate = async function(id){
    try {
        let sql=`SELECT b.titulo AS "bico", b.descricao, b.horario_inicio, b.horario_limite, b.data_inicio, b.data_limite, b.salario, b.finalizado, c.nome_fantasia AS "nome_cliente", u.nome AS "nome_usuario" FROM tbl_usuario_bico AS i
