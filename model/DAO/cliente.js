...
const selectHistoricoCliente = async function (id) {
    try {
        let sql = `select tbl_usuario.id, tbl_usuario.nome, tbl_bico.id as "id_bico", tbl_bico.titulo, tbl_bico.data_limite, tbl_bico.horario_limite, tbl_bico.data_inicio, tbl_bico.finalizado, tbl_bico.horario_inicio from tbl_bico
